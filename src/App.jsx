        ...
        <div className="bg-white text-slate-900 rounded-lg p-8 max-w-2xl mx-auto shadow-lg" id="report-area">
          ...
          <p className="text-[11px] text-slate-500 border-t border-slate-300 pt-3">
            {bracketType === "product"
              ...
              : "※吊り材・アンカーボルトの検定は簡易モデルによるものです。引張・せん断同時作用の低減（fts式）、取付部板厚の検討、3次元架構の応力解析は含まれていません。"}
          </p>
  ...
  return (
    <div>
      ...
      <p className="text-xs text-slate-400 mt-3">
        Kh表・耐震支持間隔・許容応力度式は実際の検討書掲載値と照合済みです。吊り材の検定は片持ち梁による簡易モデルで、
        ボルト・アンカーボルト耐力、取付部板厚、3次元架構解析は含みません。
      </p>
    </div>
  );
}
